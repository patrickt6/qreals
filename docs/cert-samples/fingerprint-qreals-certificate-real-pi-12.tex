...
\usepackage{breqn}
\title{Certificate for [pi]\_q (first 12 coefficients)}
\author{qreals certificate}
\date{\today}
\begin{document}
\maketitle

\noindent Input: the real number x = pi. The continued fraction is truncated to the depth that locks the first 12 coefficients (MGO Proposition 1.1).
