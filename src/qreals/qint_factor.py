...
Charles's uniqueness conjecture (Patrick / Charles, 2026-05-26): given
...
def qint_factor_peeling(P) -> QIntFactor:
    r"""Recover the multiset of integer factors via David Wehlau's peeling argument.

    Independent algorithm to qint_factor that follows David's 2026-05-26 reply:
