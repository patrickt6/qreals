...
This is a typed port of the proven catalogue in the research codebase
(computations/q_jump/jump_catalog.py, qprov record a2e94ea7); it recomputes
nothing new and packages the existing returns. The right version is
cross-checked against the independent qreals.q_rational path (the oracle), and
both q-denominators are checked to collapse to s at q = 1, so trust is verified
